      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-outline-variant pb-6">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-3xl font-bold text-on-background">Manajemen Resource</h1>
          </div>
          <p className="text-secondary text-sm mt-1">
            Monitoring utilisasi team member, pemetaan project aktif & tiket support yang dipegang, serta status ketersediaan (Idle).
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
          ...
          <div className="flex items-center gap-1.5 ml-auto">
            ...
            >
              ...
              <option value="workload">Beban Kerja Terbanyak</option>
              <option value="employeeId">NIP</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface-container-lowest border border-outline-variant rounded-xl shadow-sm overflow-hidden">
        {isLoading ? (
          <div className="p-16 flex flex-col items-center justify-center gap-3 text-secondary">
            ...
            <span className="text-sm font-medium">Memuat data alokasi resource...</span>
          </div>
        ) : resources.length === 0 ? (
          <div className="p-16 text-center text-secondary flex flex-col items-center justify-center gap-2">
            ...
            <span className="font-bold text-sm text-on-background">Tidak Ada Resource Ditemukan</span>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-surface-container-low border-b border-outline-variant text-secondary font-bold uppercase tracking-wider">
                  ...
                  <th className="py-3.5 px-4">Project yang Dipegang (Belum Close)</th>
                  <th className="py-3.5 px-4">Support yang Dipegang (Belum Close)</th>
                  <th className="py-3.5 px-4 text-center">Riwayat Selesai</th>
